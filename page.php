...
<section class="new-content">
<article id="post-34" class="ktz-page post-34 page type-page status-publish hentry">
<div class="inner-box">
...
<br>
To support the artist please buy music and video from the source of law is concerned. Or buy NSP, or I-Ring track with the official.
</div>
</article></div></aside></div></div></section></div> ';
} else if ($p == 'contact') {
$title       = 'Contact - ';
...
include 'inc/header.php';
echo '
    <div class="dlmenu center"><h1  class="ha" >Contact</h1></div>
<div class="menus">
...
<br>
Specify content copyright that you think have been violated. If you are claiming infringement of multiple copyrighted works in one email then please write the list in detail along with the website address containing the infringing content.
<br>
Inform your name, phone, office address and email address to allow us to contact you.
If you have a good faith then send the email itself, is not permitted when emails are from agents or third parties.
Written information must be accurate, and under penalty of forgery.
</div>
</article></div></aside></div></div></section></div>';
}
